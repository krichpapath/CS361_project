...
public class dialog_page1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailTextView.setText(R.string.c1_w2);
        charImageView1.setImageResource(R.drawable.mc_cry);
        ...
        //change background 2
        //scene5
        dialogues.add(new Dialog(getString(R.string.c1_s6)," " , 0, 0,R.drawable.bg_2));
        ...
        //scene6
        dialogues.add(new Dialog(null, getString(R.string.c1_w14),0, R.drawable.tae_surprised,R.drawable.bg_3));
        ...
        changeTextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Index >= 0 && Index < dialogues.size()) {
                    ...
                    Intent intent = new Intent(dialog_page1.this, dialog_page2.class);
    ...
    private void handleOptionAction(String action) {
        switch (action) {
            case "gameOver":
                Intent gameOverIntent = new Intent(dialog_page1.this, GameOverPage.class);
                ...
                break;
            case "gameOverCat1":
                Intent gameOverCat1Intent = new Intent(dialog_page1.this, GameOverPage.class);
                ...
                break;
            case "gameOverCat2":
                Intent gameOverCat2Intent = new Intent(dialog_page1.this, GameOverPage.class);
