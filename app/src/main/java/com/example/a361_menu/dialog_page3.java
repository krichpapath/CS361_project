...
public class dialog_page3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogues.add(new Dialog(null, getString(R.string.c2_pued_reaction_2), 0, R.drawable.empty));
        dialogues.add(new Dialog(null, getString(R.string.c2_ricardo_dialog_2), 0, R.drawable.ricardo_normal));
        dialogues.add(new Dialog(null, getString(R.string.c2_mc_thoughts), R.drawable.mc_scared, 0));
